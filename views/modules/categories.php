...
<div class="Box BoxCategories">
   ...
   <ul class="PanelInfo PanelCategories">
      ...
      ?>><span><strong><?php echo Anchor(Img('applications/dashboard/design/images/rss.gif'), '/discussions/feed.rss', 'PanelRSS').Anchor(Gdn_Format::Text(T('All Discussions')), '/discussions'); ?></strong><span class="Count"><?php echo number_format($CountDiscussions); ?></span></span></li>
<?php
   ...
   foreach ($this->Data->Result() as $Category) {
      ...
      if ($DoHeadings && $Category->Depth == 1) {
         ...
         echo Wrap(Anchor(($Category->Depth > 1 ? '↳ ' : '').Img('applications/dashboard/design/images/rss.gif'), '/categories/'.$Category->UrlCode.'/feed.rss', 'PanelRSS').Anchor(Gdn_Format::Text($Category->Name), '/categories/'.rawurlencode($Category->UrlCode)), 'strong')
